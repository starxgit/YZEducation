...
<article class="page-container">
	<form class="form form-horizontal" id="addSword" method="post">
		
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">
			<span class="c-red">*</span>学校id：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  id="school_id" name="school_id">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  id="sensitive_word" name="sensitive_word">
			</div>
		</div>
		<div class="row cl">
