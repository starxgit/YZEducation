...
<span class="c-gray en">&gt;</span> 交流管理 
<span class="c-gray en">&gt;</span> 敏感词管理
<a  class="btn btn-success radius" style="margin-left:50px;" data-title="添加敏感词" href="http://localhost:8080/YZEduadmin/sword/add" >添加敏感词</a>
...
<div class="page-container">
	...
	<div class="mt-20">
		...
		<table id="mytable" class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
			   <core:forEach var="sword" items="${swords}">
				<tr class="text-c">
					<td><input type="checkbox" value="" name=""></td>
					<td>${sword.school_name}</td>
					<td>${sword.sensitive_word}</td>
					<td>
					<a name="edit" href="../sword/edit?sensitive_word_id=${sword.sensitive_word_id}" class="Hui-iconfont" title="编辑">
					&#xe6df;
					</a> 
					<a name="deliete" href="../sword/del?sensitive_word_id=${sword.sensitive_word_id}" class="Hui-iconfont" title="删除">
					&#xe6e2;
					</a>
					</td>
				</tr>
