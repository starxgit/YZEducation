...
<div class="page-container">
	...
	<div class="mt-20">
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
			   <core:forEach var="entered" items="${entereds}">
				<tr class="text-c">
					<td><input type="checkbox" value="" name=""></td>
					<td>${entered.school_name}</td>
					<td>${entered.school_type}</td>
					<td><img style="width:100px;" src="http://www.fstechnology.cn:8080/YZEduFileServer/showImg?myfile=${entered.school_badge}"></td>
					<td>${entered.school_introduce}</td>
					<td>${entered.school_city}</td>
					<td>${entered.school_province}</td>
					<td><img style="width:100px;" src="http://www.fstechnology.cn:8080/YZEduFileServer/showImg?myfile=${entered.school_license}"></td>
					<td>${entered.applicant_user_name}</td>
					<td>${entered.receiver_phone}</td>
					<td>${entered.receiver_mail}</td>
					<td>
					<%-- <a name="edit" href="../enter/edit?enter_id=${entered.enter_id}" class="Hui-iconfont" title="修改">
					&#xe6df;
					</a>  --%>
					<a name="delete" href="../enter/deld?enter_id=${entered.enter_id}" class="Hui-iconfont" title="删除">
					&#xe6e2;
					</a>
					</td>
				</tr>
