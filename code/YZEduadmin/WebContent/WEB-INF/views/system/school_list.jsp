...
<span class="c-gray en">&gt;</span> 院校管理 
<a  class="btn btn-success radius" style="margin-left:50px;" data-title="添加院校" href="http://localhost:8080/YZEduadmin/school/add" >添加信息</a>
			...
			<tbody>
			   <core:forEach var="school" items="${schools}">
				<tr class="text-c">
					...
					<td>
					<a name="edit" href="school/edit?school_id=${school.school_id}" class="Hui-iconfont" title="编辑">
					&#xe6df;
					</a> 
					<a name="deliete" href="school/del?school_id=${school.school_id}" class="Hui-iconfont" title="删除">
					&#xe6e2;
					</a>
					</td>
				</tr>
