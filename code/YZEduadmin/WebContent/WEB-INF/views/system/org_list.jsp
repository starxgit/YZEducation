			...
			<tbody>
			   <core:forEach var="school" items="${schools}">
				<tr class="text-c">
					...
					<td>
					<a name="edit" href="../school/edit1?school_id=${school.school_id}" class="Hui-iconfont" title="编辑">
					&#xe6df;
					</a> 
					<a name="deliete" href="../school/del1?school_id=${school.school_id}" class="Hui-iconfont" title="删除">
					&#xe6e2;
					</a>
					</td>
				</tr>
