	...
	<form class="form form-horizontal" id="addUser" method="post">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${school.school_name}"  id="school_name" name="school_name">
			</div>
		</div>
		...
		<div class="row cl">
			...
			院校介绍：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="" value="${school.school_introduce}" id="school_introduce" name="school_introduce">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">
			所在城市：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${school.school_city}" id="school_city" name="school_city">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">所在省份：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${school.school_province}" placeholder="" id="school_province" name="school_province">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<select name="school_type" class="select">
					<option value="${school.school_type}">教育机构</option>
				</select>
				</span>
			</div>
		</div>
