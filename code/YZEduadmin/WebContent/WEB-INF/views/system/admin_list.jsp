...
<a  class="btn btn-success radius" style="margin-left:50px;" data-title="添加管理员" href="http://localhost:8080/YZEduadmin/admin/add" >添加管理员</a>
...
<div class="page-container">
	...
	<div class="mt-20">
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
			   <core:forEach var="admin" items="${admins}">
				<tr class="text-c">
					...
					<td>
					<a name="modify" href="../admin/edit?admin_account=${admin.admin_account}" class="Hui-iconfont" title="重置">
					&#xe66c;
					</a>
					<a name="deliete" href="../admin/del?admin_account=${admin.admin_account}" class="Hui-iconfont" title="删除">
					&#xe6e2;
					</a>
					</td>
				</tr>
