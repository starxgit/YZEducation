...
<article class="page-container">
	<form class="form form-horizontal" id="editPinfor" method="post">
		
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">
			<span class="c-red">*</span>资讯标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${pinfor.platform_information_title}"  id="platform_information_title" name="platform_information_title">
			</div>
		</div>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">
			<span class="c-red">*</span>资讯内容：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${pinfor.platform_information_content}"  id="platform_information_content" name="platform_information_content">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${pinfor.platform_information_author}"  id="platform_information_author" name="platform_information_author">
			</div>
		</div>
		<div class="row cl">
