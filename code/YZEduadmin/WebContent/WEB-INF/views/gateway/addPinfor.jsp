	...
	<form class="form form-horizontal" id="addUser" method="post">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  id="platform_information_title" name="platform_information_title">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  id="platform_information_content" name="platform_information_content">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">
			<span class="c-red">*</span>资讯作者：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  id="platform_information_author" name="platform_information_author">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="file" class="input-text" id="platform_image_url" name="platform_image_url">
			</div>
		</div>
		<div class="row cl">
