...
<article class="page-container">
	<form class="form form-horizontal" id="addUser" method="post">
		...
		<div class="row cl">
			...
			<span class="c-red">*</span>轮播图片：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="file" class="input-text" value="${banner.banner_image}"  id="banner_image" name="banner_image">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<select name="banner_type" class="select">
					<option value="${banner.banner_type}">${banner.banner_type}</option>
					<option value="1">网页广告</option>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">
			<span class="c-red">*</span>相关链接：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${banner.banner_link}"  id="banner_link" name="banner_link">
			</div>
		</div>
		<div class="row cl">
