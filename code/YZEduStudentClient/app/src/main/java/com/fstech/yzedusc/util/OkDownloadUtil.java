...
public class OkDownloadUtil {
    ...
    private static OkDownloadUtil okDownloadUtil;
    private final OkHttpClient okHttpClient;

    public static OkDownloadUtil get() {
        if (okDownloadUtil == null) {
            okDownloadUtil = new OkDownloadUtil();
        }
        return okDownloadUtil;
    }
